...
extension VisionModel {
     ...
     */
    @available(iOS 17, *)
    func generateForegroundInstanceMaskRequest(image: VisionImage, orientation: CGImagePropertyOrientation? = nil, options: [VNImageOption: Any] = [:],
                                               revision: Int = 1, for sequenceHandler: VNSequenceRequestHandler? = nil) -> VNGenerateForegroundInstanceMaskRequest {
